...
<script type="text/ecmascript-6">
  ...
  import ratingselect from '../../components/ratingselect/raringselect.vue';
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .food .food-content .content .fade-enter-active,
  .food .food-content .content .fade-leave-active{
    transition: all 0.2s;
  }
  .food .food-content .content .fade-enter,
  .food .food-content .content .fade-leave-to{
    opacity: 0;
    z-index: -1;
  }
